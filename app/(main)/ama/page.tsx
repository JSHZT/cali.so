    ...
    <Container className="mt-16 sm:mt-24">
      ...
      <article className="prose dark:prose-invert">
        ...
        <ul>
          <li>
            <b>保研/考研经验</b>
            ：保研道阻且长？不知道如何规划？需要知道什么技巧？考研需要怎么准备？需要备考资源和攻略？
          </li>
          <li>
        ...
        <h2>外包服务（可以直接邮箱联系我描述需求，价格我会根据需求酌情报出）</h2>
        <p>技术栈：</p>
        <ul>
          <li>
            <b>全栈开发</b>
            ：有过几年的工作经验，更偏向于后台多一些，我做过go、java、python等不同语言的后台岗位。
          </li>
          <li>
          ...
          <li>
            <b>数据服务</b>
            ：有过两年的工作经验，包括数据爬取、数据标注等工作。
          </li>
        </ul>

        <h2>请我喝咖啡</h2>
        <p>不论你想咨询什么，或者想要鼓励支持我，请我喝杯9.9的咖啡吧！</p>
